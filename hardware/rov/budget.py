...
BOUGHT = [
    ...
    ("4 × thruster", 4 * P.THRUSTER_MASS_G, 4 * P.THRUSTER_DISPLACED_CM3, -5.0, "class estimate; MEASURE"),
    ("Pi, PCA9685, BNO055, buck, 4 ESC, wiring", 160.0, 0.0, P.TRAY_Z + 6, "inside"),
    ("camera", 12.0, 0.0, P.WINDOW_Z, "inside"),
    ("window, bezel screws, 2 glands", 40.0, 6.0, 0.0, "estimate"),
    ("2 × steel bar 150 × 20 × 8", 2 * 188.0, 2 * 24.0, P.CRADLE_FLOOR_Z - 5.0, "7.85 g/cm³"),
    ("straps, screws, tether stub", 40.0, 10.0, 0.0, "estimate"),
]
PRINT_Z = {"cradle": -30.0, "bezel": P.WINDOW_Z, "tray": P.TRAY_Z}
...
def compute():
    ...
    return {"rows": rows, "mass_g": mass, "displaced_cm3": disp, "buoyancy_g": buoy, "net_g": buoy - mass,
            ...
            "heave_n": 2 * P.THRUSTER_THRUST_N, "surge_n": 2 * P.THRUSTER_THRUST_N, "weight_n": mass / 1000 * 9.81}
