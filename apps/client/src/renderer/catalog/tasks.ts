...
export const TASKS: Task[] = [
  ...
  { key: "search", name: "Find it",
    asks: "Something is in a sixty by thirty-six metre patch ahead. You are not told where.",
    judgedOn: ["passing over it", "how long it took", "ground covered"],
    objective: { kind: "search", widthM: 60, heightM: 36, altitudeM: 8.0, seeM: 12,
      target: { dx: 46, dy: 25 }, timeLimitS: 1500 } },
