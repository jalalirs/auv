"""BlueROV2 Heavy, as the catalogue describes it. Generated; do not edit."""
...
VEHICLE = Vehicle(
    ...
    thrusters=(
        ...
        Thruster('vertical-front-right', (0.12, 0.218, 0.0), (0.0, 0.0, 1.0)),
        Thruster('vertical-front-left', (0.12, -0.218, 0.0), (0.0, 0.0, 1.0)),
        Thruster('vertical-rear-right', (-0.12, 0.218, 0.0), (0.0, 0.0, 1.0)),
        Thruster('vertical-rear-left', (-0.12, -0.218, 0.0), (0.0, 0.0, 1.0)),
    ),
    sensors=(
    ...
    capability=(145.642, 145.642, 206.0, 44.908, 24.72, 38.886),
    dynamics=DYNAMICS,
)
